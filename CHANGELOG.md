...
### Major style changes
- `src/assets/jss/components/tasksStyle.jsx`
- `src/assets/jss/checkboxAdnRadioStyle.jsx`
- `src/assets/jss/components/customTabsStyle.jsx`
- `src/assets/jss/components/snackbarContentStyle.jsx`
...
### Major style changes
- `src/assets/jss/components/footerStyle.jsx`
- `src/assets/jss/components/headerStyle.jsx`
### Added dependencies
- `@babel/runtime v7.0.0-beta.55`
### Update dependencies
...
- Added styles for `svg`'s, **font-awesome** classes and `.material-icons` class inside
  - `src/assets/jss/views/dashboardStyle.jsx`
  - `src/assets/jss/components/buttonStyle.jsx`
  - `src/assets/jss/components/cardFooterStyle.jsx`
  - `src/assets/jss/components/cardHeaderStyle.jsx`
  - `src/assets/jss/components/headerLinksStyle.jsx`
  - `src/assets/jss/components/customTabsStyle.jsx`
- Others
  - `src/assets/jss/tooltipStyle.jsx`
  - `src/assets/jss/dropdownStyle.jsx`
### Dropped components
...
### Major style changes
- Moved the styles of `src/components/` inside `src/assets/jss/components/`
- Moved the styles of `src/layouts/` inside `src/assets/jss/layouts/`
- Moved the styles of `src/views/` inside `src/assets/jss/views/`
- Almost all styles have been changed more or less
### Dropped components
- `src/components/CustomButtons/IconButton.jsx` (instead use `src/components/Button.jsx` with `justIcon` prop)
...
- `src/components/CustomTabs.jsx` (instead of `src/components/Cards/TasksCard.jsx`)
### Deleted dependencies
...
## [1.2.0] 2018-04-16
### Bug Fixing
- Renamed `src/containers/App/App.jsx` to `src/layouts/Dashboard.jsx`
- Renamed `src/variables/styles.jsx` to `src/assets/jss/material-dashboard-react.jsx`
- Moved all the files from `src/variables/styles/` to `src/assets/jss/`
